...
function showMeme() {
    ...
    memeElem.setAttribute('src', randomMemeUrl);

    clearAll();

    memeContainer.appendChild(memeElem);
}
...
function revealAnswers() {
    ...
    if (document.querySelector('#riddle-answer') != null) {
        ...
        alert('There is no riddle to reveal any answer for!');
    }
}
